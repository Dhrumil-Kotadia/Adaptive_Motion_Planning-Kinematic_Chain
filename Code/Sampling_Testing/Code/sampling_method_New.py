...
class SamplingMethod():
    ...
    def check_collision(self, config1, config2):
        ...
        """
        # Write Collision check for each obstacle edge HeaderRegistry
        return self.robot.check_collision(config1, config2, self.map)
    ...
    def check_collision_config(self, config):
        ...
        """
        # Write Collision check for each point here

        return self.robot.check_collision_config(config, self.map)
